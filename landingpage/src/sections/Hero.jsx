    ...
    <div className='flex flex-col w-full justify-between mt-12 mx-auto  p-12'>
      ...
      <div className='flex flex-col max-w-screen-xl mx-auto'>
        ...
        <div className='max-w-xl flex mx-auto gap-6'>
          ...
          <Button variant = 'outline' className="  text-[#6046CF] border-[#6046CF] hover:text-black hover:bg-white focus:ring-4 f font-medium rounded-3xl text-sm px-4 py-2 text-center "
           >Get Started</Button>
        </div>
      </div>
      {/* Second div */}
      ...
      <div className=' md:flex gap-8 justify-evenly mt-8 mx-auto items-end'>
  {/* Image 1 */}
  <div className='hidden md:block w-80 h-72 p-5  rounded-lg shadow-xl text-center'>
  <img src={image4} alt="hero image" className='w-full h-full object-cover rounded-3xl' />
  </div>

  {/* Image 2 */}
  <div className="w-[600px] h-[475px] max-w-sm  rounded-3xl shadow-lg text-center">
